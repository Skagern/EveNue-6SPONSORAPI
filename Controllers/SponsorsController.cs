...
namespace GruppNrSexAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class SponsorsController : ControllerBase
    {
        private readonly GruppgitContext _context;

        public SponsorsController(GruppgitContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Sponsors
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Sponsor>>> GetSponsorer()
        {
